...
export const FacultySettings: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto animate-in fade-in duration-300">
      <div className="mb-4">
        <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Faculty Account Settings</h2>
        <p className="text-xs text-slate-500 font-medium">Manage mentor details and credentials</p>
      </div>
      ...
      <Card title="Faculty Details" subtitle="Department of Computer & Communication Engineering">

...
export const StudentDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      {/* Top Welcome Banner */}
      <div className="bg-gradient-to-r from-[#002B5C] via-[#004990] to-slate-800 text-white rounded-[24px] p-5 sm:p-6 lg:p-8 shadow-md relative overflow-hidden flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <div className="bg-white p-5 rounded-[20px] border border-slate-200/80 shadow-2xs hover:shadow-md transition-all col-span-2 sm:col-span-1">
      ...
      <Card title="Quick Action Submissions" subtitle="Upload industry certificates, submit research papers, or register AI projects">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
          ...
          >
            ...
            <span className="font-bold text-slate-800">Add Certificate &amp; Learning Activity</span>
          </Link>
          ...
          >
            ...
            <span className="font-bold text-slate-800">Submit Research Paper</span>
          </Link>

...
class DbStore {
  ...
  async getStudentPassport(studentId: number) {
    ...
    const approvedHours = allHours
      .filter((lh: any) => lh.status === 'Approved' && !this.isAutoGeneratedLearningHour(lh))
    ...
    const badges = [
      {
        ...
        level: 'Level 1',
        description: 'Complete 10+ AI Learning Hours (20+ points)',
      ...
      },
      {
        ...
        level: 'Level 2',
        description: 'Earn 2+ Approved AI Certifications (100+ points)',
      ...
      },
      {
        ...
        level: 'Level 3',
        description: 'Build 2+ Approved AI Projects (200+ points)',
      ...
      },
      {
        ...
        level: 'Level 4',
        description: 'Publish 1+ Approved AI Research Paper (150+ points)',
      ...
      },
      {
        ...
        name: 'CCE AI Pioneer',
        level: 'Level 5',
        description: 'Reach 500+ AI points across approved activities',
      ...
      },
      {
        ...
        level: 'Level 6',
        description: 'Reach 100+ Learning Hours plus 3+ Projects and 1+ Paper',
